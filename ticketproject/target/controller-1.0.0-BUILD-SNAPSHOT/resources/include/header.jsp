      ...
      <div class="user-links">
      	<sec:authorize access="isAnonymous()">
   		...
   		<sec:authorize access="isAuthenticated()">
   			<sec:authentication property="principal.username" var="userId"/> <!-- 시큐리티 태그라이브러리에서 로그인 할 때 사용한 id를 꺼내오는 건데 시큐리티에서는 무조건 username이 id임 그래서 var로 userId로 바꿔서 씀 -->
			<a href="logout.do">로그아웃</a> | <a href="<c:url value="/mypage/mypage.do?userId=${userId}" />">마이페이지</a>
		</sec:authorize> 
	      </div>
