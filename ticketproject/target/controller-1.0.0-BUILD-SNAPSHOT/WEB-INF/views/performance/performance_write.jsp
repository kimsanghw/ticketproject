...
/*section*/
      ...
      <section>
        <form action="${pageContext.request.contextPath}/performance_writeOk" method="post">
        	<input type="hidden" name="hallid" value="${hall.hallid}">
            <h1 class="write_page">공연 등록</h1>
            <div class="steps">
                <div class="step step3">
                    <p>공연명</p>
                    <input type="text" style="margin-top: 30px;">
                    <button class="search-button" type="button">검색</button>
                    <ul class="search-results" style="list-style: none; margin-top: 10px;"></ul>
                ...
                <div class="step step2">
                    <p>공연장</p>
                    <div>
                        <input type="button" class="address" name="halladdress" value="${hall.halladdress}">
                    </div>
                </div>
            ...
            <div class="btn_box">
                <button class="reservation_button">등록하기</button>
            </div>
        </form>
      </section>
